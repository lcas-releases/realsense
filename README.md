## realsense_ros (kinetic) - 2.3.0-1

The packages in the `realsense_ros` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release -y --no-web -t kinetic -r kinetic realsense_ros` on `Fri, 15 Nov 2019 18:14:26 -0000`
